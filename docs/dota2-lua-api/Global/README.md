...
[Vector CalcClosestPointOnEntityOBB(handle_1, Vector_2)](CalcClosestPointOnEntityOBB)|Compute the closest point on the OBB of an entity.|✔️
...
[handle CreateHTTPRequest(string_1, string_2)](CreateHTTPRequest)|Create an HTTP request.|✔️
[handle CreateHTTPRequestScriptVM(string_1, string_2)](CreateHTTPRequestScriptVM)|Create an HTTP request.|✔️
...
[QAngle VectorToAngles(Vector_1)](VectorToAngles)|Get Qangles (with no roll) for a Vector.|✔️
